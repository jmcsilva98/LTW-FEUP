<?php function select_country($country) {?>
...
<option value="Libyan Arab Jamahiriya" <?=$country=="Libyan Arab Jamahiriya"?'selected':''?>>Libyan Arab Jamahiriya</option> 
...
<option value="Netherlands Antilles" <?=$country=="Netherlands Antilles"?'selected':''?>>Netherlands Antilles</option> 
...
<option value="Saint Helena" <?=$country=="Saint Helena"?'selected':''?>>Saint Helena</option> 
...
<option value="Serbia and Montenegro" <?=$country=="Serbia and Montenegro"?'selected':''?>>Serbia and Montenegro</option> 
